...
>
> **Why it belongs —** SmolVLA, Diffusion Policy, and π₀ all still emit chunks. The fight moved to how the chunk is generated.
...
> - **plus →** [[Mind Map/Nodes/cvae|CVAE over chunks]]
> - **plus →** [[Mind Map/Nodes/temporal-ensembling|Temporal ensembling]]

> [!incoming] Incoming relationships
> - **← chunks are —** [[Mind Map/Nodes/seq-models|Sequence models]]
> - **← mitigated by —** [[Mind Map/Nodes/compounding-error|Compounding error]]
> - **← uses —** [[Mind Map/Nodes/diffusion-policy|Diffusion Policy]]
> - **← uses —** [[Mind Map/Nodes/vqbet|VQ-BeT]]
