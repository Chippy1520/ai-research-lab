...
> **Why it belongs**
> If this becomes real outside one lab, dataset size is no longer the only scaling law.
...
- [[Mind Map/Nodes/gen15|GEN-1.5]] — claimed-by
- [[Mind Map/Nodes/learning|Learning]] — includes
- [[Mind Map/Nodes/sim2real|Sim-to-real]] — touches
- [[Mind Map/Nodes/skild-s1|Skild S1]] — claimed-by
- [[Mind Map/Nodes/tesla-optimus|Tesla Optimus]] — claims-adjacent
...
- Canonical record: `intelligence/mindmap.json#one-shot`
- Live graph: https://chippy1520.github.io/ai-research-lab/mindmap.html#node=one-shot
